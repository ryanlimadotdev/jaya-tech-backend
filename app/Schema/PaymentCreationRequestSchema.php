...
#[Schema(
	...
	properties: [
		...
		new OA\Property(property: 'installments', description: 'Number of installments', type: 'integer', minimum: 1),
		...
		new OA\Property(property: 'payer', description: 'Payer information', required: ['email', 'identification'], properties: [
			new OA\Property(property: 'email', type: 'string', default: 'example@email.com'),
			new OA\Property(property: 'identification', required: ['type', 'number'], properties: [
				new OA\Property(property: 'type', type: 'string', default: 'CPF', anyOf: ['CPF', 'CNPJ']),
				new OA\Property(property: 'number', type: 'string', default: '12345678910')
			], type: 'object')
		], type: 'object'),
	]
)]
